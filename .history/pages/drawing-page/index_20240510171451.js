        ...
        <div className={styles.bottom}>
          <div className={styles.tools}>
            <button className={tool == "pen" && styles.selected} onClick={handlePenClick}>
              <Image src={tool == "pen" ? "/images/Penselected.svg" : "/images/Pen.svg"} width={800} height={800} alt="pen tool" tabIndex={6}/>
            </button>
            <button className={tool == "brush" && styles.selected} onClick={handleBrushClick}>
              <Image src={tool == "brush" ? "/images/Brushselected.svg" : "/images/Brush.svg"} className={styles.brush} width={800} height={800} alt="brush tool" tabIndex={7}/>
            </button>
            <button className={tool == "eraser" && styles.selected} onClick={handleEraserClick}>
              <Image src={tool == "eraser" ? "/images/Eraserselected.svg" : "/images/Eraser.svg"} className={styles.eraser} width={800} height={800} alt="eraser tool" tabIndex={8}/>
            </button>          
          </div>
          <div className={styles.utils}>
          <button>
              <Image src="/images/camera.png" width={100} height={100} alt="camera icon" tabIndex={9}/>
            </button>   
            <button onClick={handleSaveDrawing}>
              <Image src="/images/save.png" width={100} height={100} alt="save icon" tabIndex={10}/>
            </button>  
            <button onClick={handleSubmitDrawing}>
              <Image src="/images/check.png" width={100} height={100} alt="submit icon" tabIndex={11}/>
            </button>    
          </div>
        </div>
      </div>
