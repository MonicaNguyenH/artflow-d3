      ...
      <div>
        {score == 0 && 
          <div className={styles.resultContent}>
            ...
            <p className={styles.resultCaption}>"The only way to do great work is to love what you do."</p>
            <p className={styles.resultContent}>You attempted 5 questions, and 0 of them (0%) are correct!</p>
          </div>
        }
        {score == 1 && 
          <div className={styles.resultContent}>
            ...
            <p className={styles.resultCaption}>"Every artist was first an amateur."</p>
            <p className={styles.resultContent}>You attempted 5 questions, and 1 of them (20%) are correct!</p>
          </div>
        }
        {score == 2 && 
          <div className={styles.resultContent}>
            ...
            <p className={styles.resultCaption}>"Every artist dips his brush in his own soul."</p>
            <p className={styles.resultContent}>You attempted 5 questions, and 2 of them (40%) are correct!</p>
          </div>
        }
        {score == 3 && 
          <div className={styles.resultContent}>
            ...
            <p className={styles.resultCaption}>"The artist is nothing without the gift, but the gift is nothing without work."</p>
            <p className={styles.resultContent}>You attempted 5 questions, and 3 of them (60%) are correct!</p>
          </div>
        }
        {score == 4 && 
          <div className={styles.resultContent}>
            ...
            <p className={styles.resultCaption}>"Art enables us to find ourselves and lose ourselves at the same time."</p>
            <p className={styles.resultContent}>You attempted 5 questions, and 4 of them (80%) are correct!</p>
          </div>
        }
        {score == 5 && 
          <div className={styles.resultContent}>
            ...
            <p className={styles.resultCaption}>"Creativity takes courage."</p>
            <p className={styles.resultContent}>You attempted 5 questions, and 5 of them (100%) are correct!</p>
          </div>
        }
      </div>
      <div className={styles.quizSummary}>
        <div>
          <div className={styles.dropdown} onClick={() => {setDropdownOpen(!dropdownOpen)}}>
            ...
            {dropdownOpen ? <Image src={'/images/quiz/minimize.png'} alt="minimize" height={5} width={19} /> :
            <Image src={'/images/quiz/down-arrow.png'} alt="arrow down" height={10} width={20} />}
          </div>
          { dropdownOpen &&
