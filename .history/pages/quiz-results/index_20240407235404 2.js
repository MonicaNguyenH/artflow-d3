      ...
      <div>
        {score == 0 && 
          <div className={styles.resultContent}>
            ...
            <p className={styles.resultCaption}>You attempted 5 questions, and 0 of them (0%) are correct!</p>
          </div>
        }
        {score == 1 && 
          <div className={styles.resultContent}>
            ...
            <p className={styles.resultCaption}>You attempted 5 questions, and 1 of them (20%) are correct!</p>
          </div>
        }
        {score == 2 && 
          <div className={styles.resultContent}>
            ...
            <p className={styles.resultCaption}>You attempted 5 questions, and 2 of them (40%) are correct!</p>
          </div>
        }
        {score == 3 && 
          <div className={styles.resultContent}>
            ...
            <p className={styles.resultCaption}>You attempted 5 questions, and 3 of them (60%) are correct!</p>
          </div>
        }
        {score == 4 && 
          <div className={styles.resultContent}>
            ...
            <p className={styles.resultCaption}>You attempted 5 questions, and 4 of them (80%) are correct!</p>
          </div>
        }
        {score == 5 && 
          <div className={styles.resultContent}>
