    ...
    <main className={styles.main}>
        ...
        <div className={styles.container}>
            <div className={styles.profile}>
                <img alt="arrow" src='/images/Team/shirin.jpeg' width={100} height={100}/>
            ...
            <div className={styles.profile}>
                    <img alt="arrow" src='/images/Team/monica.jpeg' width={100} height={100}/>
                    <div className={styles.profileContent}>
                        <h1>Monica Nguyen</h1>
                        <h2>Designer/Developer</h2>
            ...
            <div className={styles.profile}>
                <img alt="arrow" src='/images/Team/jumi.jpeg' width={100} height={100}/>
                <div className={styles.profileContent}>
                    <h1>Jumi Pham</h1>
                    <h2>Designer/Developer</h2>
            ...
            <div className={styles.profile}>
                <img alt="arrow" src='/images/Team/callista.jpeg' width={100} height={100}/>
                <div className={styles.profileContent}>
                    <h1>Callista Chan</h1>
                    <h2>Designer/Developer</h2>
