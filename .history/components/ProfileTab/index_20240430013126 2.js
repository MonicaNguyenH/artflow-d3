        ...
        <div className={styles.main}> 
            <div className={styles.tab}>
                <button
                    ...
                    <img className={styles.gird} src="/images/grid-profile.svg" alt="dog profile image"/>
                </button>
                <button
                    className={activeTab === 2 ? 'active' : ''}
                    onClick={() => handleTabChange(2)}>
                    <img className={styles.heart} src="/images/heart-white-profile.svg" alt="dog profile image"/>
                </button>
            </div>
