        ...
        <div className={styles.main}> 
            <div className={styles.tab}>
                <button
                    ...
                    <img className={styles.girdIcon} src="/images/grid-profile.svg" alt="dog profile image"/>
                </button>
                <button
                    className={activeTab === 2 ? 'active' : ''}
                    onClick={() => handleTabChange(2)}>
                    <img className={styles.heartIcon} src="/images/heart-white-profile.svg" alt="dog profile image"/>
                </button>
            </div>
