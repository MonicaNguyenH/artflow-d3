...
<>
    <main className={styles.main}>
        <HeaderArea title="Team Member" description="Team members information page"/>
        ...
        <div className={styles.container}>
            ...
            <div className={styles.profile}>
                ...
                <div className={styles.profileContent}>
                    <h1>Monica Nguyen</h1>
                    <h2>Designer/Developer</h2>
                    <p>As a tired designer and developer with a passion for good grades, Monica developed the ArtFlow app for creators to use art as a medium to relax and combat art block. Likes to eat, hates life sometimes.</p>
                </div>
            </div>
            <div className={styles.profile}>
                <div className={styles.profileImg}>
