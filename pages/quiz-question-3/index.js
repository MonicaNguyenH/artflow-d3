...
export default function QuestionThree() {
  ...
  return (
    <div className={`${styles.question_3} ${styles.quiz}`}> 
    <nav className={styles.quizQuestionNav}>
      <div>&nbsp;</div>
      <div className={styles.progress}>
        <div className={styles['progress-value']}></div>
      </div>
      <p><span className={styles.pinkNumber}>3</span>/5</p>
    </nav>
      {answerSubmitted &&
      ...
      <div className={styles.quiz}>      
        ...
        <div className={styles.questions}>
          ...
          <label htmlFor="b" className={selectedValues.question_3 === 'B' ? styles.selected : ''}>B. The Last Supper</label>
