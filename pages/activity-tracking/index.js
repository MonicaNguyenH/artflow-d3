            ...
            <div className={styles.body}>
                {/*Gradient Mesh card*/}
                    <div className={styles.funFact}>
                        {/*<h2 className={styles.funFactHeader}> Fun Fact</h2>*/}
                    ...
                    <div className={styles.activityContributes}>
                        <h2 className={styles.activityContributesHeader}>Activity Tracker</h2>
                        <div className={styles.activityGraph}>
                            <ActivityGraph/>
                        </div>
                        <div className={styles.streaks}>
                            <h2 className={styles.streakHeader}>Streaks</h2>
                        ...
                        <div className={styles.entries}>
                            <h2 className={styles.entriesHeader}>Entries</h2>
