  ...
  return (
    <div className={styles.gradientMesh}>
        <div  className={styles.grainyContainer}>
            <svg width="430" height="932" viewBox="0 0 430 950" fill="none" fillOpacity="0.4" xmlns="http://www.w3.org/2000/svg">
                <filter id="grainy">
                    <feTurbulence 
                        type="turbulence"
                        baseFrequency={1}
        ...
        <div className={styles.Shape10}>
            <svg width="289" height="292" viewBox="0 0 289 292" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M222.829 2.67858C274.831 -13.9151 342.649 90.741 345.67 185.394C348.615 277.666 301.723 238.569 191.712 305.408C211.284 273.165 -14.1166 336.603 1.76484 300.382C17.6462 264.162 117.871 155.664 140.583 122.239C163.295 88.8144 170.827 19.2723 222.829 2.67858Z" fill="#F94E9B" fill-opacity="0.6"/>
            </svg> 
        </div>
    </div> 
  );
