    ...
    <>
      <div className={styles.promptCardBG}>
        <div className={styles.Shape1}>
          ...
          >
            <path
              d="M-0.749191 102.26C-31.6999 69.4683 12.147 25.5936 37.9392 7.75524C122.635 -36.6508 172.826 147.805 158.187 168.3C143.548 188.795 73.4908 199.043 88.1297 168.3C102.769 137.558 37.9392 143.251 -0.749191 102.26Z"
              fill="#910BEA"
              fillOpacity="1"
            />
          </svg>
        ...
        <div className={styles.Shape3}>
          ...
          >
            <path
              d="M286.596 117.861C300.048 85.694 270.155 10.102 165.527 -5.98145C143.107 -1.15642 100.658 10.7453 110.224 19.752C122.181 31.0104 217.841 150.028 211.862 156.461C205.884 162.894 7.09076 156.461 1.11203 175.761C-4.8667 195.061 113.213 252.961 189.442 248.136C265.671 243.311 273.144 150.028 286.596 117.861Z"
              fill="#4A10D1"
              fillOpacity="1"
            />
          </svg>
        ...
        <div className={styles.Shape6}>
          ...
          >
            <path
              d="M-10.0223 106.281C-42.4534 71.9204 3.49071 25.9472 30.5166 7.25569C119.264 -39.2743 171.855 154.004 156.516 175.479C141.177 196.955 67.7686 207.693 83.1076 175.479C98.4467 143.266 30.5166 149.232 -10.0223 106.281Z"
              fill="#910BEA"
              fillOpacity="1"
            />
          </svg>
